...
void PrepareScene()
{
	...
	int lightInst1 = renderer->AddInstance(lightQuad1, mat4::Translate(-16.0f, 20.0f, -12.0f));
	int lightInst2 = renderer->AddInstance(lightQuad1, mat4::Translate(8.0f, 20.0f, -12.0f) * mat4::RotateX(1.0f) * mat4::Scale(2.0f));
